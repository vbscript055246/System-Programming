...
# outputtext = ""
# print(output_file[0])
# for index, item in enumerate(output_file[1:], 1):
#     if CT == 10 or (item == '' and output_file[index-1] == '' and output_file[index+1] == ''):
#         outputtext = outputtext.replace("##", "{:0>2x}".format(len(outputtext[9:])//2).upper())
#         print(outputtext)
#         CT = 0
#         continue
#
#     if CT == 0:
#         if index != 1:
#             outputtext = "T{:0>6x}".format(int(LOCCTR_record[index], 16)).upper()
#         else:
#             outputtext = "T{:0>6x}".format(int(LOCCTR_record[0], 16))
#         outputtext += "##"
#
#     outputtext += item
#     CT += 1
